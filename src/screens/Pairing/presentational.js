...
class Pairing extends PureComponent {
  ...
  componentDidMount() {
    ...
    if(paired === false ) { // not checking this would cause an error in next screens
  ...
  render() {
    ...
    return <Frame theme="colorful">
      <NavigationEvents
        onDidBlur={payload => pairingDone()}
      />
      <Heading margins="mb3">
        {t('screens.pairing.title', translation)}
      </Heading>
      <Paragraph additionalStyles="f7 mb3">
          {t('screens.pairing.text', translation)}
      </Paragraph>
      <ActivityIndicator
      ...
      <View cls="flx-i pt4 jcfe">
        <Illustration
          src={require('./../../../assets/images/pairing.png')}
        />
      </View>
    </Frame>
  }
