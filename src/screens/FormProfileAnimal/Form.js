...
import { KeyboardAvoidingView, Vibration, View, Image, TouchableHighlight, TouchableOpacity, Dimensions } from 'react-native'
...
class Form extends PureComponent {
  ...
  render() {
    const { translation, onSubmit, values } = this.props
    const { picture, name, species } = values
    const { currentStep } = this.state
    const steps = [
      {
        component: <Frame theme="clear">
          <View cls="flx-i">
            <Illustration
              src={require('./../../../assets/images/data_animal.png')}
            />
          </View>
          <KeyboardAvoidingView style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }} behavior="padding">
            <Heading margins="mb3 tac">{t(`labels.yourAnimalProfile.${species}`, translation)}</Heading>
            <TextInput value={name} placeholder={t('placeholders.name', translation)} onInput={this._handleTypeName} />
        ...
        component: <View cls="flx-i" style={{ position: 'relative' }}>
          {picture ? <Fragment>
            <Image
              cls="absolute"
              style={{
              ...
              source={{ uri: picture }}
            />
            <TouchableOpacity onPress={this._removePicture} cls="br5 absolute" style={{
              bottom: 40,
            ...
            <View cls="absolute aic jcc" style={{
              left: 0,
              bottom: 120,
              width: Dimensions.get('window').width,
            }}>
              <TouchableOpacity
                onPress={onSubmit}
                type="italic" cls="pa3 br5 bg-white"
                style={{
                  elevation: 30,
                }}>
              ...
              />
              <TouchableOpacity onPress={this._takePicture} cls="absolute br5 bg-transparent" style={{
                bottom: 40,
              ...
              <BlurView tint="light" intensity={50} cls="br5 absolute aic jcc" style={{
                height: 50,
              ...
              >
                <TouchableOpacity cls="tac" style={{
          ...
          <BlurView tint="light" intensity={25} cls="br5 absolute flxdr ph3 pv1 aic jcc" style={{
            right: 10,
            top: 10,
            elevation: 15,
          }}>
