...
class Form extends PureComponent {
  ...
  render() {
    const { translation, onSubmit, values, shouldDisplayBack } = this.props
    const { picture, name, species } = values
    const { currentStep } = this.state
    const steps = [
      {
        component: (
          <Frame withBackButton={shouldDisplayBack} theme="clear">
            <View cls="flx-i">
              <Illustration src={require("./../../../assets/images/data_animal.png")} />
            </View>
            <KeyboardAvoidingView
          ...
          <View cls="flx-i" style={{ position: "relative" }}>
            {picture ? (
              ...
              <Fragment>
                ...
                >
                  <TouchableOpacity cls="tac" style={{}} onPress={this._pickPicture}>
